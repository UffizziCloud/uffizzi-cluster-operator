...
test-e2e-with-cluster-local: start-test-k3d test-e2e-with-cluster ## Run test.
...
test-e2e-with-tainted-cluster-local: start-test-k3d-tainted test-e2e-with-tainted-cluster ## Run test.
